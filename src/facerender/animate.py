...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, seed_video_path, character, enhancer, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        if seed_video_path != 'XXX':
            ...
            print(f"After imageio.mimsave. path is {path}") 
        ...
        print(f"audio_path {audio_path}, audio_name is {audio_name}  new_audio_path is {new_audio_path}") 
        ...
        return_path = save_video_with_watermark(path, new_audio_path, av_path, character, watermark= False)
        print(f'The generated video is saved and the path returned is {return_path}') 
        ...
        if enhancer:
            ...
            save_video_with_watermark(enhanced_path, new_audio_path, av_path_enhancer, character, watermark= False)
